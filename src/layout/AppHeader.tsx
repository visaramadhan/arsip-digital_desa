        ...
        >
          ...
          <div className="relative" ref={userDropdownRef}>
            ...
            >
              ...
              <span className="block mr-1 font-medium text-theme-sm">{user?.displayName || "User"}</span>
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M14.7839 6.22065C15.0768 5.92775 15.5516 5.92775 15.8445 6.22065L19.5945 9.97065C19.8874 10.2635 19.8874 10.7384 19.5945 11.0313L15.8445 14.7813C15.5516 15.0742 15.0768 15.0742 14.7839 14.7813C14.491 14.4884 14.491 14.0135 14.7839 13.7206L17.2536 11.251H8.99992C8.58571 11.251 8.24992 10.9152 8.24992 10.501C8.24992 10.0868 8.58571 9.75098 8.99992 9.75098H17.2536L14.7839 7.28131C14.491 6.98841 14.491 6.51354 14.7839 6.22065ZM11.9999 3.501C12.4141 3.501 12.7499 3.16521 12.7499 2.751C12.7499 2.33678 12.4141 2.001 11.9999 2.001H5.49992C3.56692 2.001 2.00008 3.56783 2.00008 5.50083V15.501C2.00008 17.434 3.56692 19.0008 5.49992 19.0008H11.9999C12.4141 19.0008 12.7499 18.665 12.7499 18.2508C12.7499 17.8366 12.4141 17.5008 11.9999 17.5008H5.49992C4.39535 17.5008 3.50008 16.6056 3.50008 15.501V5.50083C3.50008 4.39626 4.39535 3.501 5.49992 3.501H11.9999Z"
                        fill=""
                      />
                    </svg>
                    Sign out
